...
function DiffCard({
  ...
  return (
    <div className="grid grid-cols-[auto_1fr] gap-8 p-8 rounded-xl border border-border bg-card hover:border-brand-600/40 transition-colors">
      {/* left: number + icon */}
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="w-11 h-11 rounded-lg flex items-center justify-center text-white bg-brand-600">
          {icon}
        </div>
      </div>
      {/* right: text */}
      ...
      <section className="py-20 bg-background border-t border-border">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* USDA */}
            <div className="rounded-xl p-10 bg-card border border-border">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-6 bg-brand-600/15 border border-brand-600/40 text-brand-600">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
