          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3 rounded p-8 bg-card border border-border">
              <div className="flex items-center gap-3 mb-7">
                ...
                <h2 className="font-display font-bold text-card-foreground text-xl">{c.formTitle}</h2>
              </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <div className="flex items-center gap-3 mb-7">
                  <div className="w-5 h-px bg-brand-600" />
                  <h2 className="font-display font-bold text-foreground text-xl">{c.infoTitle}</h2>
                </div>
