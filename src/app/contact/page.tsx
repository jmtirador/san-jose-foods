...
const inputClass =
  'w-full bg-background border border-border rounded px-4 py-3 text-sm font-sans text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-1 focus:ring-brand-600 focus:border-brand-600 transition'
...
function InfoItem({
  ...
  return (
    <div className="flex items-start gap-4">
      <div className="w-9 h-9 rounded flex items-center justify-center flex-shrink-0 bg-brand-600/10 text-brand-600">
        {icon}
      </div>
      <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3 rounded p-8 bg-card border border-border">
              <div className="flex items-center gap-3 mb-7">
                ...
                <h2 className="font-display font-semibold tracking-tight text-card-foreground text-xl">{c.formTitle}</h2>
              </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <div className="flex items-center gap-3 mb-7">
                  <div className="w-5 h-px bg-brand-600" />
                  <h2 className="font-display font-semibold tracking-tight text-foreground text-xl">{c.infoTitle}</h2>
                </div>
              ...
              <div className="rounded p-5 border border-border bg-card">
