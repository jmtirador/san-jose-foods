...
export default function ContactPage() {
  ...
  // Format the fields into a WhatsApp message and hand off to the buyer's app —
  // the real conversion path for this trade. Native `required` validation runs
  // first, so an incomplete form never reaches here.
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3 rounded-xl p-8 bg-card border border-border">
              ...
              <p className="font-sans text-muted-foreground text-sm mb-7 ml-8">{c.formNote}</p>

              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="name" className="block font-sans text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">{c.name}</label>
                    <input
                  ...
                  <div>
                    <label htmlFor="company" className="block font-sans text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">{c.company}</label>
                    <input
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="email" className="block font-sans text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">{c.email}</label>
                    <input
                  ...
                  <div>
                    <label htmlFor="phone" className="block font-sans text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">{c.phone}</label>
                    <input
                ...
                <div>
                  <label htmlFor="interest" className="block font-sans text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">{c.interest}</label>
                  <select
                ...
                <div>
                  <label htmlFor="message" className="block font-sans text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">{c.message}</label>
                  <textarea
