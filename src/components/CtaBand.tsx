    ...
    <section className="bg-brand-600 text-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 py-24">
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-7 font-mono text-[11px] uppercase tracking-[0.2em] text-white/60">
          ...
          <p className="font-sans text-white/85 text-lg max-w-xl mb-10 leading-relaxed">{h.ctaSub}</p>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 border border-white/40 text-white/90 hover:text-white hover:border-white font-medium px-7 py-3.5 rounded-sm transition-colors"
            >
              {h.ctaBtn}
            </Link>
          </div>

          <div className="mt-12 pt-6 border-t border-white/20 font-mono text-[10px] uppercase tracking-[0.2em] text-white/55">
